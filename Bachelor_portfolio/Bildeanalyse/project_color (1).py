...
Original file is located at
    https://colab.research.google.com/drive/11JmdOsD88NBsla7U959TfUT-cLRIhYfD
"""

# Commented out IPython magic to ensure Python compatibility.
# Run code cell if you want to clone the latest yolov5 version from git
...
!python /content/yolov5/train.py --img 640 --batch 16 --epochs 30 --data color.yaml --weights yolov5s.pt --cache
...
!zip -r /content/detect_color.zip /content/yolov5/runs/detect

from google.colab import files
files.download('/content/detect_color.zip')